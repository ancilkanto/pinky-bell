...
export default function GetAQuote() {
  return (
    <div className="fixed bottom-[20px] right-[20px] max-[480px]:bottom-[40px] max-[480px]:right-[40px] z-[200] w-[140px] h-[140px] flex items-center justify-center max-[768px]:scale-50 origin-bottom-right">
      {/* Circular text */}
      <svg
